...
var Rating_instructions_1 = {
  ...
  stimulus:
    ...
    " You will have to evaluate members of the blue group and members of the yellow group on the same series of traits as in Part 1."+
...
var rating_blue = {
        type: 'survey-likert',
        post_trial_gap: 200,
        preamble: "<br><br><b><i>The "+color_blue+" group is a group that...</b></i><br><br>",
        questions: [
          {prompt: "<b>Tends to be quiet.</b>", labels: scale_questionnaire, required: true},
          {prompt: "<b>Is compassionate, has a soft heart.</b>", labels: scale_questionnaire, required: true},
          {prompt: "<b>Tends to be disorganized.</b>", labels: scale_questionnaire, required: true},
...
var rating_yellow = {
        type: 'survey-likert',
        post_trial_gap: 200,
        preamble: "<br><br><b><i>The "+color_yellow+" group is a group that...</b></i><br><br>",
        questions: [
          {prompt: "<b>Tends to be quiet.</b>", labels: scale_questionnaire, required: true},
          {prompt: "<b>Is compassionate, has a soft heart.</b>", labels: scale_questionnaire, required: true},
          {prompt: "<b>Tends to be disorganized.</b>", labels: scale_questionnaire, required: true},
