...
var memory_group = {
 ...
 /* EXIT FULLSCREEN MODE */
  ...
  debrief += "beteween these groups of items: When two groups (e.g., self words and blue faces) shared the same response key, we expected "; 
  ...
  debrief += "self words as more similar to yourself in the third part (e.g., a more 'extroverted' if you think you are 'extroverted'). <br><br>"; 
