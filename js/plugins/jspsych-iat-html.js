 ...
 **/
 ...
 var html_str = "";
    ...
    html_str += "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0'><p id='jspsych-iat-stim' class='" + trial.category + "'>" + '<span style="font-size: 40px">'+ trial.stimulus +  '</span>'+ "</p></div>";
